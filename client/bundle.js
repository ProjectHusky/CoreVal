...
var _QueryForm = __webpack_require__(28);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        { className: "App" },
        _react2.default.createElement("header", { className: "jumbotron-fluid mt-4" }),
...
var QueryFormView = function (_React$Component) {
    ...
    _createClass(QueryFormView, [{
        ...
        value: function handleSubmit(evt) {
            ...
            evt.preventDefault();
            fetch("/api/eval/" + this.state.query, {}).then(function (response) {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            "button",
                            { id: "searchbutton", type: "button", className: "btn btn-success" },
                            _react2.default.createElement(
                                "span",
                ...
                this.state.searchFinished ? _react2.default.createElement(_QueryList2.default, { results: this.state.courseArr }) : "Welcome"
            );
        }
    }]);
            ...
            if (results.length === 0) {
                ...
                results.forEach(function (queryResult) {
                    for (var id in queryResult) {
                        var courseInfo = queryResult[id];
                        console.log(queryResult);
                        queryResultArr.push(_react2.default.createElement(_QueryResult2.default, { key: id, courseInfo: courseInfo }));
                    }
                });
...
var QuerySearchView = function (_React$Component) {
    ...
    _createClass(QuerySearchView, [{
        key: "render",
        value: function render() {
            var info = this.props.courseInfo;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "table",
                        { className: "table table-sm table-condensed" },
                        _react2.default.createElement(
                            "thead",
                            null,
                            _react2.default.createElement(
